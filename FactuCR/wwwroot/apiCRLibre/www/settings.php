...
#####################################################################################
# Database name
$config['db']['name'] = "db_a42d7c_dev";
# Database password
$config['db']['pwd'] = '2y5rNOBamiGS';
# Database user name
$config['db']['user'] = "a42d7c_dev";
# Database host
$config['db']['host'] = "mysql5019.site4now.net";
##############################################################################
#
# Crypto Keys
#
##############################################################################
$config['crypto']['key'] = "AbZ3579q80qFxFlnK7s53bmRhgmw0PfnUZDAnFMtpCE=";
##############################################################################
#
# print alerts
# false or true
...
$config['users']['sessionLifetime'] = 5000;
